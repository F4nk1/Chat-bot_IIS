...
DATOS_ENTRENAMIENTO = [
    ...
    ("cuáles son los servicios de bienestar de la unsaac", "Bienestar"),
    ("dónde queda la oficina de bienestar universitario", "Bienestar"),
    ("cómo solicito la beca comedor", "Bienestar"),
    
    ("cómo son las prácticas pre-profesionales", "Practicas"),
    ("hay convenios para pasantías", "Practicas"),
    ("requisitos para iniciar mis prácticas", "Practicas"),
    ("dónde presento mi informe de prácticas pre profesionales", "Practicas"),
    ("cuántas horas de prácticas necesito para egresar", "Practicas"),
    ...
    ("cuál es el régimen de permanencia en la unsaac", "Reglamentos"),
    ("qué sanciones existen para los alumnos", "Reglamentos"),
    ("reglamento de disciplina estudiantil", "Reglamentos"),
    ...
    ("convenios de intercambio estudiantil en la unsaac", "Movilidad"),
    ("requisitos para irme de intercambio académico", "Movilidad"),
    ...
    ("cuántos créditos obligatorios tiene la carrera", "Cursos_General"),
    ("qué pasa si desapruebo un curso electivo", "Cursos_General"),
    ...
    ("quiero saber cuándo es mi próxima tutoría", "Tutorias_General"),
    ("cuándo se realizan las tutorías del semestre", "Tutorias_General"),
    ("cuáles son los momentos clave de tutoría", "Tutorias_General"),
    ("qué contiene el expediente del tutorado", "Tutorias_General"),
    ("quién supervisa las tutorías en la escuela", "Tutorias_General"),
    ("cuántos estudiantes tiene a cargo un tutor", "Tutorias_General"),
    ("se puede cambiar de tutor asignado", "Tutorias_General"),
    ("deber de confidencialidad en las tutorías", "Tutorias_General"),
    ("cuándo se evalúa el programa tutorial", "Tutorias_General"),
    ("qué temas puedo hablar con mi tutor en la primera reunión", "Tutorias_General"),
    ("puedo pedir ayuda a mi tutor para organizar mis estudios", "Tutorias_General"),
    ("qué hago si una dificultad personal está afectando mis estudios", "Tutorias_General"),
